	...
	<div class="untree_co-section before-footer-section">
		<div class="container">
			<div class="row my-5">
				<form class="col-md-12" method="post">
					<div class="site-blocks-table">
						<input type="hidden" id="member_id" class="member_id"
							value="${sessionScope.member_id}">
						<table id="cart-table" class="table">
							<thead>
								<tr>
									<th class="goods-select"><input type="checkbox"
										class="input-check-all" checked="checked"></th>
									...
									<c:forEach items="${cartList}" var="vo">
										<tr>
											<td class="td_width_1 cart_info_td"><input
												type="checkbox" class="individual_input_check"
												checked="checked"> <input type="hidden"
												class="individual_price_input" value="${vo.price}">
												<input type="hidden" class="individual_deliveryPrice_input"
												value="${vo.delivery_charge}"> <input type="hidden"
												class="individual_goods_id" value="${vo.goods_id}">
											</td>
											<td class="goods-info"><img
												src="resources/images/${vo.img_file}" alt="Image"
												class="img-fluid" style="width: 100px; height: 100px;" /></td>
											<td class="goods-info"><span class="h5 text-black">${vo.goods_name}</span>
											</td>
											<td>
												<div
													...
													<button class="btn btn-outline-black decrease"
														type="button" value="-1">&minus;</button>
													<input type="text"
														class="form-control text-center quantity-amount"
														value="${vo.c_amount}" readonly />
													<button class="btn btn-outline-black increase"
														type="button" value="1">&plus;</button>
												</div>
											</td>
											<td>${vo.price}원</td>
											<td>택배
												<div>${vo.delivery_charge}원</div>
											</td>
											<td><button class="btn delete-btn btn-outline-black"
			...
			<div style="text-align: center">
				<a href="shop.do?goods_type=전체&goods_sort=like_count DESC"><button
						class="btn btn-outline-black btn-sm btn-block">계속 쇼핑하기</button></a>
			</div>
				...
				<div class="under-cart-table">
					<table id="calTotal-table" class="table table-responsive">
						<tr>
							...
							<td rowspan="2"><button id="payBtn" class="btn btn-black">주문하기</button></td>
						</tr>
						<tr>
