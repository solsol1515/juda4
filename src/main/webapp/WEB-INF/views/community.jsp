				...
				<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
					...
					<li class=""><a class="nav-link"
						href="shop.do?goods_type=전체&goods_sort=like_count DESC">우리술
							구경하기</a></li>
					<li class="active"><a class="nav-link" href="community.do">우리들의
							공간</a></li>
				</ul>
			...
			<div class="row justify-content-between">
				<div class="col-lg-12">
					<div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
						...
						<p class="mb-4" id="boardRules">
							우리 모두가 함께 사용하는 공간입니다. <br />비속어 등 상대방에게 불쾌감을 줄 수 있는 내용은
							삼가주시기바랍니다.
						</p>
					</div>
				</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 col-md-9 col-lg-9 mb-5 mb-md-0" align="center">
				<a class="product-item" id="boardList" align="center"><h4>
						<b>글 목 록</b>
					</h4>
					<br />
				<br />
					...
					<br />
				<br /> <a href="insertBoard.do"><b>새 글 등록</b></a> </a>
			</div>
			<!-- End Column 1 -->
