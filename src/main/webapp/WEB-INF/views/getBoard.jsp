...
<body>
	...
	<form action="updateBoard.do" method="get" id="boardForm">
		...
		<table border="0" cellpadding="5" cellspacing="0" class="boardTbl">
			<tr>
				<td class="td1">번호</td>
				<!-- 시퀀스 값 가져오기 -->
				<td align="left"><input type="hidden" name='q_id'
					value="${board.q_id}" />${board.q_id}</td>
			</tr>
			<tr>
				<td class="td1">조회수</td>
				<!-- 클릭한 횟수 +1로 가져오기(UPDATE) -->
				<td align="left"><input type="hidden" name='view_count'
					value="${board.view_count}" />${board.view_count}</td>
			</tr>
			<tr>
				<td class="td1">작성자</td>
				<td align="left"><input type="hidden" name='member_id'
					value="${board.member_id}" />${board.member_id}</td>
			</tr>
			<tr>
				<td class="td1">등록일</td>
				<td align="left"><input type="hidden" name='q_date'
					value="${board.q_date}" />${board.q_date}</td>
			</tr>
			<tr>
				<td width="100" class="td1">제목</td>
				<td align="left"><input type="text" name='q_title'
					value="${board.q_title}" style="width: 343px;" /></td>
			</tr>
			<tr>
				<td class="td1">내용</td>
				<td align="left"><textarea cols="40" rows="10" name='q_content'
						style="text-align: left !important">${board.q_content}</textarea></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="submit"
					class="submit" value="글  수 정" /></td>
			</tr>
		</table>
	</form>
	<br />
	...
	<div class="bottomList">
		<a href="insertBoard.do">글 등록하기</a>&nbsp;&nbsp;&nbsp; <a
			href="deleteBoard.do?q_id=${board.q_id}">글 삭제하기</a>&nbsp;&nbsp;&nbsp;
