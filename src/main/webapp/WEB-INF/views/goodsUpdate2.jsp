...
<!-- 					alt="Image" class="img-fluid" name="img_file" style="width: 400px; height: 400px;" /> -->
...
<!-- 					alt="Image" class="img-fluid" name="img_sangse" style="width: 400px; height: 400px;" /> -->
<!-- 					<br /> <input type="file" name='file' maxlength="60" size="40"> -->
<!-- 				</td> -->
<!-- 			</div> -->
		...
		<tr>
			...
			<td>
				<div
					...
					<input type="submit" class="goodsBtn" value="상 품 수 정 하 기">
				</div>
			</td>
