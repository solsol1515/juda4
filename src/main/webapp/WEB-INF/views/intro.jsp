		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarsFurni">
				<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
					<li class="active"><a class="nav-link" href="intro.do">우리들의
							이야기(소개)</a></li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					...
					<p>우리 나라의 다양한 술을 소개하고, 와인같이 세계적으로 더 유명해졌으면 좋겠다라는 생각이 그 시작이었습니다.
						한국인뿐만아니라 외국인들에게도 대한민국의 술을 물었을 때 소주라는 대답이 아닌 더 다양한 답변을 들을 수 있었으면 하는
						생각에 전통주라는 주제로 프로젝트를 시작하게 되었습니다.</p>
				</div>
				<!-- End Column 1 -->
				...
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					...
					<p>조별로 토의를 하던중에 주다관련 좋은 내용이 있어서 참여하게되었습니다. 다른 조원분들 의견중 전통주에 대한
						프로젝트에 참여할수있어서 좋았습니다. 그 중에서 외국인분들에게 전통주를 소개할수있다는 취지가 좋았습니다. 외국인분들중
						막걸리는 비교적 잘 알려져있다고 생각합니다. 그러나 지역적으로 외국인뿐만 아니라 우리 한국인들도 잘 모르는 토종술도
						많습니다. 외국 가까운 이웃나라인 일본에서조차 장인정신이란게 점점 사라지고있고, 통계적으로는 특히 젊은층들이 그러한
						가업을 이으려는 사회적 기조가 줄어들고있다고 들었습니다. 그런 와중에 우리나라에서도 전통을 지키려는 사람들이 많지만,
						그것보다 더 중요한것은 시대에 맞게 그러한 것들의 변형 혹은 혁신이나 다양한 사람들, 또 다변화를 통한 많은 시도를
						해야된다는것입니다. 더 이상 전통에 대한 고집은 21세기에 맞춰서 진보할수 없다고 생각합니다. 또한 그러한 외국인들의
						시선에서 다양한 해석이 이른바 선비사상이나 문화사대주의에서 벗어나서 우리나라가 현재 kpop열풍을 이끌어갈수있었던
						원동력이 되지않았나생각합니다. kpop 역시 콘서트나 오프라인을 통하여 많은 확산이 있었지만, 21세기에 인터넷을
						쓸수없으면 사회에서 도태되듯이, 많은 선진국이든 개발도상국이든, 인터넷을 통하여 문화의 흐름을 읽기 마련입니다. 그것에
						맞춰서 저희 조에서도 홈페이지를 통해서 좀더 다양한 전통주들을 mz세대나 외국인들에게 알리려고하였고, 외국인에게도 그에
						맞는 안주를 소개함으로써, 우리나라의 식문화에 대해서도 자연스럽게 받아들일 수 있는 일종의 장치가 되었으면 합니다.
						그와 함꼐, 전통주가 지금보다 성공하기위해서는 지금보다 더 많은 리큐르를 제공할수있어야하고, 그에 맞게 서양칵테일과도
						접목할수있어야한다고 생각합니다. 지금은 많은 바텐더들이 바텐이라고 무시받지않고, 지금은 일종의 직업으로서 알려지고있고,
						이러한 서양식 바텐더 문화뿐만아니라 우리나라 술문화 역시도 서양문화와 조화될수있고, 바의 문화 뿐만아니라, 우리나라의
						전통주가 하나의 세계화를 이끌수있고, 하나의 직업까지도 양산할수있기를 바랍니다.</p>
				</div>
				<!-- End Column 3 -->
