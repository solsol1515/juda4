		...
		<div class="container py-4">
			...
			<div class="row align-items-center justify-content-between">
				<a class="navbar-brand h1 text-center" href="index.do"> <span
					class="text-dark h4">회 원 가 입</span>
				</a>
			</div>
				...
				<div class="col-md-4">
					<form action="joinSuccess.do" method='post' id="usercheck">
						<div class="form-group">
							<label for="member_id" class="form-label mt-4">아이디</label> <input
								type="text" class="form-control" id="member_id" name="member_id"
								required>
							<div class="eheck_font" id="id_check"></div>
						</div>
						<div class="form-group has-success">
							<label class="form-label mt-4" for="password">비밀번호</label> <input
						...
						<div class="form-group has-danger">
							<label class="form-label mt-4" for="password2">비밀번호 재확인</label> <input
								type="password" class="form-control" id="password2" required>
						...
						<div class="form-group">
							<label for="gender" class="form-label mt-4" readonly>성별</label> <select
						...
						<div class="form-group row">
							...
							<div class="col">
								<span class="ps_box"> <input type="text"
									class="form-control" id="phone_num2" maxlength="4"
									name="p_num2" required>
								</span>
							</div>
							<div class="col">
								<span class="ps_box"> <input type="text"
									class="form-control" id="phone_num3" maxlength="4"
									name="p_num3" required>
								</span>
							</div>
						</div>
						...
						<div class="d-grid gap-5">
							<div class="form-group">
								<div class="form-group">
									<label for="email" class="form-label mt-4">이메일</label> <input
										...
										placeholder="*****@***.com" name="email" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								이메일&nbsp;&nbsp;&nbsp;&nbsp; <input type="checkbox"
									name="agree_sns"> SNS <br /> <span>* 본 동의 사항은
									선택사항으로 거부 할 수 있으며, 거부하시더라도 서비스 이용에 제한은 없습니다. 단, 이벤트 정보, 신제품 출시
									등 맞춤형 서비스를 제공 받으실 수 없습니다.</span>
							</div>
